 ...
 * [uberonfovt.yml](uberonfovt.yml)
     * Determines how your purl.obolibrary.org/obo/uberonfovt/ redirects will be handled
     ...
     * Paste in the contents of [uberonfovt.yml](uberonfovt.yml)
 ...
 * [uberonfovt.md](uberonfovt.md)
     ...
     * Paste in the contents of [uberonfovt.md](uberonfovt.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
